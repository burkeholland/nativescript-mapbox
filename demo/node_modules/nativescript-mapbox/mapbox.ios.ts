...
import { MapBox as MapBoxCommon } from "./mapbox-common";
...
declare var MGLMapViewDelegate: any;
declare var CGRectMake: any;
declare var MGLMapView: any;


class MapViewDelegateImpl extends NSObject {

    private static ObjCProtocols = [MGLMapViewDelegate];

    private _owner: WeakRef<MapBox>;

    public static initWithOwner(owner: WeakRef<MapBox>): MapViewDelegateImpl {
...
export class MapBox extends MapBoxCommon {
    ...
    public setCenter(arg): Promise<any> {
